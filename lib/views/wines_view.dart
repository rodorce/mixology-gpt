...
class WinesView extends StatefulWidget {
  final WinesController controller;

  WinesView({required this.controller});
  String _searchText = '';

  @override
  _WinesViewState createState() => _WinesViewState();
}

class _WinesViewState extends State<WinesView> {
  String _searchText = '';
  List<Item> _filteredItems = [];
  final List<Widget> _views = [WinesView(controller: WinesController())];
  int _currentIndex = 0;
